...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    <div class="section-title text-center">
                        ...
                        <p class="mb-0" style="">Lorem Ipsum is simply dummy text of the printing and typesetting
        ...
        <div id="branches" class="container">
            ...
            <div class="row justify-content-center g-4 mt-4">
                <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                    <div class="gshop-animated-iconbox py-5 px-4 text-center border rounded-3 position-relative overflow-hidden hover-shadow">
                        ...
                        <a href="http://vismaya_web.test/branch" class="text-dark fs-sm fw-bold d-block mt-3">Vegetable</a>
    ...
    <section class="pb-100 pt-80 position-relative overflow-hidden z-1 trending-products-area">
        <img src="assets/img/shapes/garlic.png" alt="garlic" class="position-absolute garlic z--1" data-parallax="{&quot;y&quot;: 100}" style="transform:translate3d(0px, 48.388px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(0px, 48.388px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); ">
        <img src="assets/img/shapes/carrot.png" alt="carrot" class="position-absolute carrot z--1" data-parallax="{&quot;y&quot;: -100}" style="transform:translate3d(0px, -48.358px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(0px, -48.358px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); ">
        <img src="assets/img/shapes/mashrom.png" alt="mashrom" class="position-absolute mashrom z--1" data-parallax="{&quot;x&quot;: 100}" style="transform:translate3d(48.388px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(48.388px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); ">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section-title text-center">
                        ...
                        <div class="swiper-slide" style="width: 25%;">
                            <div class="vertical-product-card rounded-2 position-relative border-0 bg-white" style="box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.2);">
                                <div class="thumbnail position-relative text-center p-4">
                                    <a href="#"><img src="assets/img/products/apple.png" alt="apple" class="img-fluid"></a>
                                </div>
                                <div class="card-content text-center">
                                    <a href="product-details.html" class="card-title fw-bold d-block mb-2"><h4>Dried Onion Kinh Men</h4></a>
          ...
          <section style="margin-top:50px;" class="feedback-section pt-120 has-banner-bottom position-relative z-1 overflow-hidden bg-floral-white">
        ...
        <div id="contact-us" class="row justify-content-center pt-120">
            <div class="col-xl-12">
