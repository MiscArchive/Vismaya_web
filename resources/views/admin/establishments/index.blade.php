                ...
                <div class="card-body">
                    <div class="row align-items-center ">
                        <div class="col-xxl-3 col-lg-6 me-auto">
                            <h6 class="card-title">Establishments</h6>
                        </div>
                        <!--end col-->
                        <div class="col-xxl-auto col-auto">
                            <a href="{{ route('establishments.create') }}" class="btn btn-primary"><i
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === true) {
                            ...
                            $('#establishment-table').DataTable().ajax.reload(null, true);
                        } else {
