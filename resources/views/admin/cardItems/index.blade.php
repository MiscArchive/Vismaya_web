                ...
                <div class="card-body">
                    <div class="row align-items-center ">
                        <div class="col-xxl-3 col-lg-6 me-auto">
                            <h6 class="card-title">Card Items</h6>
                        </div>
                        <!--end col-->
                        <div class="col-xxl-auto col-auto">
                            <a href="{{ route('card-items.create') }}" class="btn btn-primary"><i
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === true) {
                            ...
                            $('#carditem-table').DataTable().ajax.reload(null, true);
                        } else {
